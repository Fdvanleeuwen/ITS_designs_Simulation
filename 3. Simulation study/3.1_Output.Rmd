...
```{r}
X <- forms_for_sim(N_time = 6, var = 20, Intercept =170,  Slope = 12.7, step_size = -3,slope_size =  -10)
X
```

```{r, warning = F}
test <- gen_data(X$form, X$v_name, X$var, N_person = 50, X$Intercept, var_time = 10)
test$wide
...
# model not running
helper = test$wide
GCM1_fit <- growth(final_lgm, data=helper)
...
def <- defData(varname = "Score1", dist = "normal", formula = 170,
                 variance = 22)
def <- defData(def, varname = "Score2", dist = "normal", formula = "Score1+12.7",
                 variance = 28)
def <- defData(def, varname = "Score3", dist = "normal", formula = "Score2+12.7",
                 variance = 13)
def <- defData(def, varname = "Score4", dist = "normal", formula = "Score3+12.7",
                 variance = 18)
def <- defData(def, varname = "Score5", dist = "normal", formula = "Score4+12.7",
                 variance = 22)
def <- defData(def, varname = "Score6", dist = "normal", formula = "Score5+12.7",
                 variance = 28)
...
GCM1_fit <- growth(final_lgm, data=dd)
summary(GCM1_fit, standardized = TRUE)
#parameterEstimates(GCM1_fit)
```
