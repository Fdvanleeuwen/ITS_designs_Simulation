...
```{r}
X <- forms_for_sim(N_time = 10, var = 10, Intercept = 170,  Slope = 16.5, step_size = 20, slope_size =  -10, additional_step = 0)

X
```

```{r, warning = F}
test <- gen_data(X$form, X$v_name, X$var, N_person = 100, X$Intercept, var_time = 0, additional_step_corr = 1)
