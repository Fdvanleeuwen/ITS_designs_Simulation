...
```{r}
X <- forms_for_sim(N_time = 10, var = 20, Intercept = 170,  Slope = 12.7, step_size = 7, slope_size =  -8)
X
```

```{r, warning = F}
test <- gen_data(X$form, X$v_name, X$var, N_person = 1000, X$Intercept, var_time = 30)
