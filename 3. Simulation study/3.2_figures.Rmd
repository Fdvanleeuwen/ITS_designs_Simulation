...
```{r}
# import the data
out10 <- read.csv("results/sim10_3.csv")
out01 <- read.csv("results/sim01_3.csv")
out11 <- read.csv("results/sim11_3.csv")
```


```{r}
out11_neg_step <- read.csv("results/out11_neg_step_3.csv")
out11_neg_slope  <- read.csv("results/out11_neg_slope_3.csv")
out11_additional_step <- read.csv("results/out11_additional_step_3_csv")
out11_additional_step_corr <- read.csv("results/out11_additional_step_corr_3.csv")
out_time_2 <- read.csv("results/time_2.csv")
