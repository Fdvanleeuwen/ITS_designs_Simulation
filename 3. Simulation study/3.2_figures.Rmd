...
```{r}
# import the data
out10 <- read.csv("results/sim10_2.csv")
out01 <- read.csv("results/sim01_2.csv")
out11 <- read.csv("results/sim11_2.csv")
```


```{r}
out11_neg_step_2 <- read.csv("results/out11_neg_step_2.csv")
out11_neg_slope_2 <- read.csv("results/out11_neg_slope_2.csv")
out11_additional_step <- read.csv("results/out11_additional_step_2.csv")
out11_additional_step_corr_2 <- read.csv("results/out11_additional_step_corr_2.csv")
```
...
df %>% 
  ...
  facet_wrap(~effect_sizes) +
  scale_fill_viridis_c("Bias", option = "A") +
    theme_minimal()
