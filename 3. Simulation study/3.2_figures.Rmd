...
out10 %>% 
  ...
  labs(title = "Precision in pre-slope in nsim = 100", x = "Number of time points", 
       y = "Number of participants", fill="Number of times bias was > 5%") +
  facet_wrap(~effect_sizes) +
    theme_minimal()
...
The pre-slope seems to be estimated well, so i will leave it out of the rest of the figures.
...
out01 %>% 
  ...
  geom_tile() + 
  labs(title = "Precision in slope in nsim = 100", x = "Number of time points", 
       y = "Number of participants", fill="Number of times bias was > 5%") +
  facet_wrap(~effect_sizes) +
    theme_minimal()
```
...
out11 %>% 
  ggplot(aes(x = N_t, y = N_pers, fill = Precision_slope)) +
  geom_tile() + 
  labs(title = "Precisio in slope in nsim = 100", x = "Number of time points", 
       y = "Number of participants", fill="Number of times bias was > 5%") +
  facet_wrap(~effect_sizes) +
    theme_minimal()
```
